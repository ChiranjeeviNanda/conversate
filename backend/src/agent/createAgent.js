...
export const createAgent = async (user_id, channel_type, channel_id) => {
	...
	await upsertStreamUser({
		id: user_id,
		name: "AI Assistant",
		image: "https://api.dicebear.com/9.x/bottts/svg?seed=Christian&scale=70&radius=50&baseColor=546e7a&eyes=roundFrame01&face=round02&mouth=smile01&sides=square&texture[]&top=glowingBulb02&backgroundColor=c0aede",
		role: "admin",
	});
