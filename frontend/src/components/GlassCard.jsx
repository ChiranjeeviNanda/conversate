...
export const HoverCard = (className = "", children) => {
	<div
		className={`rounded-2xl p-6 h-full relative overflow-hidden group bg-gradient-to-br from-base-300/5 to-base-300/10 backdrop-blur-sm border border-base-content/20 shadow-lg hover:shadow-xl transition-all duration-500 hover:bg-gradient-to-br hover:from-primary/5 hover:to-primary/10 hover:border-primary/30
					${className}`}
	>
